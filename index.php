    ...
    <div class="modal">
      ...
      <div class="modal__dialog">
        ...
        <form action="send.php" method="POST">
          <input class ="modal__input" type="text" placeholder="Your Full Name*" name="name">
          <input class ="modal__input" type="text" placeholder="Phone Number*" name="phone">
          <input class ="modal__input" type="text" placeholder="Email*" name="email">
          <textarea class ="message modal__message"
                placeholder="Message"
                name="message"
              ></textarea>
          <div class="modal__wrappep">
